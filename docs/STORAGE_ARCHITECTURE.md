...
1. O backend valida o arquivo e envia o objeto ao Storage.
2. O registro em `files` recebe a identidade e os metadados retornados pelo upload.
3. Se o banco falhar, o backend tenta remover imediatamente os objetos enviados na mesma operacao.
4. Remocoes usam somente `bucket + storage_path`; falhas retornam informacao auditavel e nao sao ignoradas silenciosamente.
