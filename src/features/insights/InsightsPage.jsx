...
// ── Vertical bar chart (motivos reprovação, posts por canal, atividade) ──
...
// ── Horizontal bar chart (taxa aprovação / reprovação por cliente) ──
...
// ── Donut chart (projetos concluídos) ──
...
export default function InsightsPage() {
  ...
  // Rejection tags from file feedbacks
  const tagCounts = {}
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                ...
                {/* Taxa de reprovação por cliente */}
                <Card className="p-5">
              ...
              {/* Feedbacks de reprovação por arquivo */}
